...
public class ForecastFragment extends Fragment
{
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.action_refresh)
        {
            ...
            fetchWeatherTask.execute(localZipCode);
            return true;
        }
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]>
    {
        ...
        @Override
        protected String[] doInBackground(String... zipsIn)
        {
            ...
            try
            {
                ...
                Uri builtURL = Uri.parse(FORECAST_BASE_URL).buildUpon()
                        .appendQueryParameter(QUERY_PARAM, zipsIn[0])
        ...
        @Override
        protected void onPostExecute(String[] newWeather)
        {
            if (newWeather != null)
            {
                weatherDataAdapter.clear();
                weatherDataAdapter.addAll(newWeather);
            }
        }
    }
